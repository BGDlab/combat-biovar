...
fig_2 <- ggarrange(
  ...
  ), top = text_grob("Differences in males' and females' median centile errors", color = "black", hjust = 0, x = 0)),
  blank,
  ncol=3, nrow=1,
  widths=c(.5, 1, .5)),
  big_violin_plt,
...
fig_2_annotate
ggsave("figs/figure_2.jpeg", fig_2_annotate, width=11.5, height=10, units="in")
```
