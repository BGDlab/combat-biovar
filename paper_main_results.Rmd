...
```{r}
data <- data.frame(A = rnorm(1000000, mean = 7, sd = 1),
                   B = rnorm(1000000, mean = 10, sd = 2),
                   C = rnorm(1000000, mean = 13, sd = 3),
                   datatype=rep("raw", n=1000000))

ggplot(data, aes(x = A, size=1.4)) +
...
```{r}
combatgam_data %>%
ggplot(aes(size=1.4, fill=datatype, color=datatype)) +
  geom_density(aes(x=A), alpha = 0.5) +
...
combatgam_data %>%
ggplot(aes(size=1.4, fill=datatype, color=datatype)) +
  geom_density(aes(x=B), alpha = 0.5) +
...
combatgam_data %>%
ggplot(aes(size=1.4, fill=datatype, color=datatype)) +
  geom_density(aes(x=C), alpha = 0.5) +
...
```{r}
combatgamlss_data <- data.frame(A = rnorm(1000000, mean = 9.5, sd = 1.5),
                   B = rnorm(1000000, mean = 10, sd = 2),
                   C = rnorm(1000000, mean = 11, sd = 2.5),
