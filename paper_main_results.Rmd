...
big_violin_plt <- plt.df %>% 
  ...
  theme(plot.title = element_text(size=12), axis.ticks.x = element_blank(), axis.text.x = element_blank(), panel.spacing.x = unit(.1, "lines")) +
...
fig_1_annotate
ggsave("figs/figure_1.jpeg", fig_1_annotate, width=11, height=5)
```
