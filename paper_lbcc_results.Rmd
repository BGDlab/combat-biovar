...
```{r}
demo_plt <- readRDS("figs/figure_5_AB.rds")
...
ggsave("figs/figure_5_vertical.jpeg", fig5_vert, width=17, height=15, units="in")
```
...
range_delta_fig <- mean_cent_deltas_df_study %>%
  ...
  theme_linedraw()+
  theme(legend.position="none") +
  labs(x="Age Range of Primary Study Sample (Years)", y="Mean Absolute Difference in Centile Scores (Centiles)")
```
