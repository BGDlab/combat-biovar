...
gam.age.test <- lm(mean_gam_cent ~ site_mean_age, data=gam_centile_site.mean.df2)
summary(gam.age.test)
gam.age.test2 <- lm(mean_gam_cent ~ sex_prop_Female + site_n + site_mean_age, data=gam_centile_site.mean.df2)
summary(gam.age.test2)
```
...
gamlss.age.test <- lm(mean_gamlss_cent ~ site_mean_age, data=gamlss_centile_site.mean.df2)
summary(gamlss.age.test)
gamlss.age.test2 <- lm(mean_gamlss_cent ~ sex_prop_Female + site_n + site_mean_age, data=gamlss_centile_site.mean.df2)
summary(gamlss.age.test2)
```
