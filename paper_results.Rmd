...
for (feature in unique(global.cent.df$pheno)) {
 ...
 plot <- ggplot() +
      ...
      geom_line(aes(x=df$age_days, y=df$M_centile_5, color=df$dataset)) +
 ...
 plot <- ggplot() +
      ...
      geom_line(aes(x=df$age_days, y=df$F_centile_5, color=df$dataset)) +
 ...
 plot <- ggplot() +
      ...
      geom_line(aes(x=df$age_days, y=df$centile_5, color=df$dataset)) +
