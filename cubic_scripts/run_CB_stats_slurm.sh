...
#centile qsubs
cent_bash_dir=$study_dir/cb_centile_qsubs
if ! [ -d $cent_bash_dir ]
	then
	mkdir $cent_bash_dir
	else
...
#centile output csvs
cent_save_dir=$study_dir/cb_centile_csvs
if ! [ -d $cent_save_dir ]
	then
	mkdir $cent_save_dir
	else
...
config_list_nosite="lifespan-CN-imp-sites-euler-log-cf-cf.gam-batch.study-data-cb-female-data_cb_mod lifespan-CN-imp-sites-euler-log-cf-cf.gam-batch.study-data-cb-male-data_cb_mod \
lifespan-CN-imp-sites-euler-log-cf-cf.gamlss-batch.study-data-cb-female-data_cb_mod lifespan-CN-imp-sites-euler-log-cf-cf.gamlss-batch.study-data-cb-male-data_cb_mod"
...
config_list_plusraw="lifespan-CN-imp-sites-euler-log-cf-cf.gam-batch.study-data-cb-female-data_cb lifespan-CN-imp-sites-euler-log-cf-cf.gam-batch.study-data-cb-male-data_cb \
lifespan-CN-imp-sites-euler-log-cf-cf.gamlss-batch.study-data-cb-female-data_cb lifespan-CN-imp-sites-euler-log-cf-cf.gamlss-batch.study-data-cb-male-data_cb \
lifespan-CN-imp-sites-euler-raw-cb-female-data_cb lifespan-CN-imp-sites-euler-raw-cb-male-data_cb"
