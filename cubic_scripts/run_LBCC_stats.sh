...
config_list_nosite="lifespan-CN-imp-sites-euler-log-cf-cf.lm-batch.study-data_no.tbv lifespan-CN-imp-sites-euler-log-cf-cf.gam-batch.study-data_no.tbv lifespan-CN-imp-sites-euler-log-cf-cf.gamlss-batch.study-data_no.tbv lifespan-CN-imp-sites-euler-raw_no.tbv"
...
do
	...
	#qsub bash script
	qsub -N $config -o $cent_bash_dir/${config}_out.txt -e $cent_bash_dir/${config}_err.txt $bash_script
done
#######################################################################################
# CHECK FOR OUTPUTS
...
#qsub bash script
qsub -N ${config_str}_deltas -o $cent_bash_dir/${config_str}_deltas_out.txt -e $cent_bash_dir/${config_str}_deltas_err.txt $bash_script
...
config_list_plusraw="lifespan-CN-imp-sites-euler-log-cf-cf.lm-batch.study lifespan-CN-imp-sites-euler-log-cf-cf.gam-batch.study lifespan-CN-imp-sites-euler-log-cf-cf.gamlss-batch.study lifespan-CN-imp-sites-euler-raw" 
