...
config_list="lifespan-CN-imp-sites-euler-log-cf-cf.gamlss-batch.study lifespan-CN-imp-sites-euler-raw"  #lifespan-CN-imp-sites-euler-log-cf-cf.gam-batch.study #lifespan-CN-imp-sites-euler-log-cf-cf.gam-batch.site lifespan-CN-imp-sites-euler-log-cf-cf.gamlss-batch.site"
#######################################################################################
