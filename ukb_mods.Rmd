...
vol_list <- col_list[grepl("^lh_Vol|^rh_Vol|^GMV$|^WMV$|^sGMV$|^Ventricles$", col_list)]
writeLines(vol_list, con = "pheno_lists/Vol_list.txt")
...
summary(lh_SA_middletemporal_mod)
